    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                TextEntry::make('numero')->label('Número')->placeholder('-'),
                TextEntry::make('serie')->label('Série')->placeholder('-'),
                TextEntry::make('status')->label('Status')->badge(),
                TextEntry::make('valor')->label('Valor')->numeric(),
                TextEntry::make('emitida_em')->label('Emitida em')->dateTime()->placeholder('-'),
                TextEntry::make('competencia')->label('Competência')->date()->placeholder('-'),
